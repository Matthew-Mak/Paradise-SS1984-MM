...
/obj/item/reagent_containers/spray/cleaner/tactical
    ...
    desc = "Бутылочка из прочнейшего темно-синего пластика, распылитель черного цвета украшен тактическим снаряжением, разработана уборочно-силовыми структурами Нанотрейзен для ЗАЧИСТКИ и контроля грязи в помещениях"
